...
//            controller: "InvestirController",
        ...
        .state('performance', {
            url: "/performance",
            templateUrl: "performance/main.html",
        ...
        .state('historique', {
            url: "/historique",
            templateUrl: "historique/main.html",
        ...
        .state('actualites', {
            url: "/actualites",
            templateUrl: "actualites/main.html",
            data: {pageTitle: 'Actualit�s'},
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before a LINK element with this ID. Dynamic CSS files must be loaded between core and theme css files
                        files: [
                            "actualites/style.css",
                            "actualites/main.js",
                            "actualites/script.js",
                        ]
                    });
                }]
            }
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        name: 'MetronicApp',
                        files: [
                            '/dashboard/controllers/GeneralPageController.js'
                        ]
                    }]);
                }]
            }
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            '/dashboard/controllers/UserProfileController.js'
                        ]                    
                    });
                }]
            }
