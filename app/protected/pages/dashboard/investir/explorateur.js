    ...
    .controller('ExplorateurController', function($OrdersFactory, $rootScope, $scope) {
        ...
        $scope.filters = {
            ...
            entries: [
                    ...
                    questions: [
                        {
                            ...
                            answers: [
                                {
                                    id: "finance",
                                    text: "Investir dans l'économie et les entreprises",
                                    resume: "Investir dans la finance",
                                    goto: "end"
                                },
                                {
                                    id: "industry",
                                    text: "Investir pour  financer un ou des états",
                                    resume: "Investir dans l'industrie",
                                    goto: "end"
                                },
                                {
                                    id: "health",
                                    text: "Maximiser le rendement",
                                    resume: "Investir dans la santé",
                                    goto: "end"
                                },
                                {
                                    id: "collectivity",
                                    text: "Minimiser le risque",
                                    resume: "Investir dans des collectivité",
                                    goto: "end"
                                },
                ...
                {
                    id: 'actu',
                    name: 'Investir par rapport à l actualité',
                    questions: [
                        {
                            id: "mode",
                            text: "par theme",
